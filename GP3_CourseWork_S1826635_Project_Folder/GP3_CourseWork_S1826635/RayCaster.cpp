...
void RayCaster::initRayCaster(glm::mat4 projMat, glm::mat4 viewMat, glm::vec3 cameraPos)
{
...
void RayCaster::UpdateRay(glm::mat4 viewMat, float displayWidth, float displayHeight, glm::vec3 cameraPos)
{
	currentCameraPos = cameraPos;
	viewMatrix = viewMat;
